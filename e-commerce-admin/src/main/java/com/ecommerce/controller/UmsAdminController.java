...
import com.ecommerce.vojo.UserParam;
...
//    private UmsRoleService roleService;
    ...
    @ResponseBody
    public CommonResult<SysUser> register(@RequestBody UserParam umsAdminParam, BindingResult result) {
        SysUser umsAdmin = adminService.register(umsAdminParam);
        if (umsAdmin == null) {
            CommonResult.failed();
        }
        return CommonResult.success(umsAdmin,"zhucechenggong");
    }

    @ApiOperation(value = "登录以后返回token")
    @RequestMapping(value = "/login", method = RequestMethod.POST)
    @ResponseBody
    public CommonResult login(@RequestBody LoginVO umsAdminLoginParam, BindingResult result) {
