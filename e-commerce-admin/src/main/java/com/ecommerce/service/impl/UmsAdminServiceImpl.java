...
//    private UmsAdminLoginLogMapper loginLogMapper;
    ...
    public SysUser getAdminByUsername(String username) {
        ...
        List<SysUser> adminList = adminMapper.selectByExample(example);
    ...
    @Override
    public SysUser register(UserParam umsAdminParam) {
        ...
        List<SysUser> umsAdminList = adminMapper.selectByExample(example);
